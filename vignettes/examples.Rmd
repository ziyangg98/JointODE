...
with $m(0) = m_0$ and quasi-steady initial velocity
$m'(0)=\{f(0)-\omega^2m_0\}/(2\xi\omega)$. The formula uses two reserved
keywords:

- `biomarker`: latent $\log \omega_i^2$ parameter
- `velocity`: latent $\log(2\xi_i\omega_i)$ parameter

Random effects on the initial biomarker level are always included. We fit
models at increasing complexity to find the right RE structure.
